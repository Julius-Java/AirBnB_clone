...
```bash
git clone https://github.com/Julius-Java/AirBnB_clone.git
```
...
<details>
    <summary>Abubakar Ogirima</summary>
    <ul>
    <li><a href="https://www.github.com/Sadiq-iy.">Github</a></li>
    <li><a href="https://www.twitter.com/Sadiq_iy">Twitter</a></li>
    <li><a href="mailto:abubakarogirima@gmail.com">e-mail</a></li>
    </ul>
</details>
